...
\begin{figure}[htb]    	
\centering
\fbox{\includegraphics[width=\columnwidth]{TeamPhotoTeheran.jpg}}
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\columnwidth]{logo_2012.jpg} % logo may look better when smaller
...
\item[Programmers:] Auke Wiggers, Chiel Kooijman, Hessel van der Molen, Inge
    ...
    Tijmen Blankevoort, Erik van Egmond and Anna Keune.
\end{description}
